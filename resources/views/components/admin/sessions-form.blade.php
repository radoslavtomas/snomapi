<x-admin.form-section submit="{{ route('admin.users.logout_sessions', $user->id) }}" method="DELETE">
    <x-slot name="title">
        {{ __('Browser Sessions') }}
    </x-slot>

    <x-slot name="description">
        {{ __('Manage and log out user\'s active sessions on other browsers and devices.') }}
    </x-slot>
                                ...
                                <div>
                                    <div class="text-xs text-gray-500">
                                        ...
                                        @if ($session->is_current_device)
                                            ...
                                            <input type="hidden" name="current_session" value="{{ $session->id }}">
                                        @else
